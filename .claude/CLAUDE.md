# MindWell — AI Agent Configuration

## Overview

**MindWell** is a university mental health support platform connecting students with counselors.

- **Frontend:** React 19 + Vite 6 + Tailwind CSS 4 + TypeScript 6
- **Backend:** Express 5 + Drizzle ORM + PostgreSQL + WebSocket
- **Architecture:** `frontend/` + `backend/` monorepo

This project uses Claude AI for structured development workflows, specialized sub-agents, and mandatory coding standards.
...
| Rule | Description |
|------|-------------|
| `tech-stack.md` | Approved technologies (React 19, Express 5, Drizzle, PostgreSQL) |
| `system-design.md` | CAP theorem, caching, scaling, queues |
| `project-structure.md` | Monorepo: frontend/ + backend/ structure |
| `api-conventions.md` | REST standards, response envelopes |
| `mindwell-specific.md` | HIPAA, session types, counselor matching |
...
| `mindwell-specific.md` | HIPAA, session types, counselor matching, crisis detection |
