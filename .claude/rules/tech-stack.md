...
|-------|---------------|-------------|-------|
| **Frontend** | React 19 + Vite 6 (SPA) | — | Next.js (SPA, no SEO needed) |
| **UI Components** | Custom + lucide-react | shadcn/ui | MUI (too heavy) |
| **Styling** | Tailwind CSS 4 | — | Styled-components, CSS Modules |
| **Animation** | Framer Motion 12 | — | — |
| **State Management** | Zustand 5 | TanStack Query (server state) | Redux |
| **Data Fetching** | ky + TanStack Query | — | Axios alone |
| **Forms** | react-hook-form + zod | — | Formik |
| **Backend Framework** | Express 5 + Node | — | Hapi, Koa |
| **API Style** | REST | WebSocket (real-time chat) | GraphQL |
| **Language** | TypeScript (always) | — | Plain JavaScript |
| **Database** | PostgreSQL (via postgres.js) | — | MySQL, SQLite (dev only) |
| **ORM** | Drizzle ORM | — | Prisma, Sequelize, TypeORM |
| **Auth** | JWT + bcryptjs | — | Firebase Auth |
| **Email** | Nodemailer | — | SendGrid |
| **Search** | PostgreSQL FTS | — | Elasticsearch |
| **Logging** | Pino | — | console.log (production) |
