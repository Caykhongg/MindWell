...
import { createAppointmentSchema, updateAppointmentStatusSchema, } from '../../validators/appointment.schema.js';
const router = Router();
const appointmentRepo = new AppointmentRepository();
const service = new AppointmentService(appointmentRepo);
const controller = appointmentController(service);
router.get('/', authenticate, controller.list);
router.get('/therapist', authenticate, requireRole('therapist', 'admin'), controller.therapistList);
